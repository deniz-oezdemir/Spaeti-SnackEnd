...
class DatabaseConfig(
    ...
    @Bean
    fun databaseInitializer(): CommandLineRunner = CommandLineRunner {
        val products = listOf(
            Product(
                name = "Car",
                price = 1000.0,
        ...
        val carOptions = listOf(
            ...
            Option(
                name = "Black Color", quantity = 4, product = savedProducts[0]
            ),
            Option(
                name = "Automatic Transmission", quantity = 2,
                product = savedProducts[0]
            ),
            Option(
                name = "Manual Transmission", quantity = 3,
                product = savedProducts[0]
            )
        )
        ...
        val bikeOptions = listOf(
            Option(
                name = "Small Size", quantity = 10,
                product = savedProducts[1]
            ),
            Option(
                name = "Medium Size", quantity = 15,
                product = savedProducts[1]
            ),
            Option(
                name = "Large Size", quantity = 8,
                product = savedProducts[1]
            ),
            Option(
                name = "Red Color", quantity = 12,
                product = savedProducts[1]
            ),
            Option(
                name = "Black Color", quantity = 7,
                product = savedProducts[1]
            )
        )

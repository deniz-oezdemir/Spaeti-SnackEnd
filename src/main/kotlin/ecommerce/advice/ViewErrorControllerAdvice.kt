...
class ViewErrorControllerAdvice {
    ...
    fun handleOpFailed(e: OperationFailedException, model: Model): String {
    ...
    fun handleDataAccess(e: DataAccessException, model: Model): String {
    ...
    fun handleDuplicateKeyException(e: DuplicateKeyException, model: Model): String {
    ...
    fun handleEmptyResultException(e: EmptyResultDataAccessException, model: Model): String {
